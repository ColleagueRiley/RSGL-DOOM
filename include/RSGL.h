...
/* textLine starts at 1*/
RSGLDEF u32 RSGL_textLineWidth(const char* text, u32 fontSize, size_t textEnd, size_t endLine);
#endif /* RSGL_NO_TEXT */
...
u32 RSGL_textLineWidth(const char* text, u32 fontSize, size_t textEnd, size_t endLine) {
    return (u32)RFont_text_width_len(RSGL_font.f, text, textEnd, fontSize, endLine, 0.0);
}

u32 RSGL_textWidth(const char* text, u32 fontSize, size_t textEnd) {
    return (u32)RFont_text_width_len(RSGL_font.f, text, textEnd, fontSize, 0, 0.0);
}
#endif /* RSGL_NO_TEXT */
